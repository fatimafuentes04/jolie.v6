...
class Report extends FPDF
{
    ...
    const CLIENT_URL = 'http://localhost/jolie.v6/views/private/';
    ...
    public function startReport($title)
    {
        ...
        if (isset($_SESSION['id_usuario'])) {
           ...
           // $this->addPage('p', 'letter');
            ...
            $this->aliasNbPages();
            //se aliniar horizontalmente con el comentado landscape
        } else {
    ...
    */
    public function header()
    {
        ...
        $this->image('../../imagenes/logos/Jlie.png', 15, 15, 20);
        // Se ubica el título.
        $this->cell(20); //entre mas sea a las derecha y menos a la izquierda :) 
